...
import { getPostsByCategory, getAllCategories, BlogPostMeta } from '@/lib/blog';
...
export async function generateStaticParams() {
  ...
  return categories.map(c => ({ category: c.category.toLowerCase() }));
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${formattedCategory} | The Jam Blog`,
    description: `Browse all ${formattedCategory} posts on The Jam Blog`,
  };
}
