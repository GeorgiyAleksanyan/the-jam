...
import { CARRIER_GATEWAYS, RATE_LIMITS, normalizeCarrier, normalizePhone, getGatewayEmail, getSupportedCarriers, buildSendCommand, buildCheckRepliesCommand, } from './texting.js';
// Configuration
    ...
    try {
        switch (name) {
            ...
            case 'create_challenge': {
                ...
                const challengeSlug = args?.slug;
                const description = args?.description;
                const difficulty = args?.difficulty;
                const prize_pool = args?.prize_pool;
                const funding_threshold = args?.funding_threshold;
                const upvote_threshold = args?.upvote_threshold;
            ...
            case 'comment_on_challenge': {
                ...
                const challengeSlug = args?.challenge_slug;
                const body = args?.body;
                const quoteReplyTo = args?.quote_reply_to;
            ...
            case 'sms_build_command': {
                const gatewayEmail = args?.gateway_email;
